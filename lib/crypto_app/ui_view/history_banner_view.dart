...
class HistoryBannerView extends StatelessWidget {
  final AnimationController animationController;
  final Animation animation;

  const HistoryBannerView({Key key, this.animationController, this.animation})
      : super(key: key);
            ...
            child: Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                        color: CryptoTradeAppTheme.grey.withOpacity(0.6),
