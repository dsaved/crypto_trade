...
class UnsoldTradeListView extends StatefulWidget {
  ...
  @override
  _UnsoldTradeListViewState createState() => _UnsoldTradeListViewState();
}

class _UnsoldTradeListViewState extends State<UnsoldTradeListView> {
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    "Purchase Price: ${transaction['symbol2Amount']} $currency\nQuantity: ${transaction['symbol1Amount']}\nHigh: ${transaction['high']}\nLow: ${transaction['low']}\nLast: ${transaction['last']}",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
