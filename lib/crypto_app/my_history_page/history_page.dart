...
class _HistoryScreenState extends State<HistoryScreen>
  ...
  void initAll() async {
    ...
    String _transactions = prefs.getString(Constant.TRANSACTIONS_PREF_KEY);
  ...
  _getData({more = false, silent = false, page = 1, search = ""}) async {
    ...
    await _netUtil
        .post("${Constant.transactions}", context, body: params)
        .then((value) {
          setState(() {
            _loading = false;
          });
          ...
          if (value['success'] == true) {
            if (more) {
              ...
              prefs.setString(
                  Constant.TRANSACTIONS_PREF_KEY, json.encode(transactions));
            }
            _loading = false;
            _hasError = false;
            setState(() {});
          ...
          children: <Widget>[
            Builder(builder: (BuildContext context) {
              if (transactions == null) {
                ...
                listViews.add(TransactionListView(
